...
public class CropImageOptions implements Parcelable {
   ...
   */
     ...
     * the min width the crop window is allowed to be. (in pixels)
     */
    public int maxCropWindowWidth;

    /**
     * the min height the crop window is allowed to be. (in pixels)
     */
    public int maxCropWindowHeight;
    ...
    public CropImageOptions() {
        ...
        maxCropWindowWidth = (int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, 42, dm);
        maxCropWindowHeight = (int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, 42, dm);
        maxCropResultWidth = 40;
        maxCropResultHeight = 40;
        maxCropResultWidth = 99999;
        maxCropResultHeight = 99999;
    ...
    protected CropImageOptions(Parcel in) {
        ...
        maxCropWindowWidth = in.readInt();
        maxCropWindowHeight = in.readInt();
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeInt(maxCropWindowWidth);
        dest.writeInt(maxCropWindowHeight);
