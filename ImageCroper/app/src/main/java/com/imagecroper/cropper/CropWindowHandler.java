...
final class CropWindowHandler {
     ...
     * @param x the x-coordinate of the touch point
     * @param y the y-coordinate of the touch point
     * @param handleXleft the left x-coordinate of the horizontal bar handle
     * @param handleXright the right x-coordinate of the horizontal bar handle
     * @param handleY the y-coordinate of the horizontal bar handle
     * @param targetRadius the target radius in pixels
     * @return true if the touch point is in the target touch zone; false
     * otherwise
     */
    private static boolean isInHorizontalTargetZone(float x, float y, float handleXleft, float handleXright, float handleY, float targetRadius) {
        return x > handleXleft && x < handleXright && Math.abs(y - handleY) <= targetRadius;
    }
     ...
     * @param handleYleft the top y-coordinate of the vertical bar handle
     * @param handleYright the bottom y-coordinate of the vertical bar handle
     * @param targetRadius the target radius in pixels
     * @return true if the touch point is in the target touch zone; false
     * otherwise
     */
    private static boolean isInVerticalTargetZone(float x, float y, float handleX, float handleYleft, float handleYright, float targetRadius) {
        return Math.abs(x - handleX) <= targetRadius && y > handleYleft && y < handleYright;
    }
