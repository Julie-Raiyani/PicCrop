...
public final class CropImage {
    ...
    public static final class ActivityBuilder {
         ...
         * <i>Default: 42dp, 42dp</i>
         */
        public ActivityBuilder setMaxCropWindowSize(int maxCropWindowWidth, int maxCropWindowHeight) {
            mOptions.maxCropWindowWidth = maxCropWindowWidth;
            mOptions.maxCropWindowHeight = maxCropWindowHeight;
            return this;
        }
